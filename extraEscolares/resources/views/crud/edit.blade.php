...
@section('contenido')
<br>
    <p class="fs-2 text-center">Actualizar productor</p>
    ...
    <form class="row g-3 fs-4" action="{{ route ('update', $items->id)}}" method="post">
        ...
        <div class="col-md-6 mt-4">
            <label for="nombre_alumno" class="form-label">Nombre del productor <td class="icocod">&#128221;</td></label>
            <input type="text" name="nombre_alumno" id="nombre_alumno" class="form-control" value="{{ $items->nombre_alumno }}" >
        </div>
        <div class="col-md-6 mt-4">
            <label for="numero_control" class="form-label">Folio <td class="icocod">&#9997;</td></label>
        ...
        <div class="col-6 mt-4">
            <label for="carrera">Dato <td class="icocod">&#128119;</td></label>
    ...
    @endforeach
        ...
        <div class="col-6 mt-4">
            <label for="escuela_anterior">Pueblo <td class="icocod">&#127745;</td></label>
            <input type="text" name="escuela_anterior" id="escuela_anterior" class="form-control" value="{{ $items->escuela_anterior }}">
        </div>
        <div class="col-6 mt-4">
            <label for="fecha_ingreso">Fecha registro <td class="icocod">&#128198;</td></label>
